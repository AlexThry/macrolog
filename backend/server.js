...
app.put('/api/tracker/goal', authRequired, (req, res) => {
...
app.put('/api/weight', authRequired, (req, res) => {
...
app.put('/api/habits/:id/check', authRequired, (req, res) => {
...
app.put('/api/journal', authRequired, (req, res) => {
  const date = req.body?.date || todayISO();
